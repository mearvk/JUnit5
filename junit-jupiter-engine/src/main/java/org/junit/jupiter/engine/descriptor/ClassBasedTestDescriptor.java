...
public class ClassBasedTestDescriptor extends JupiterTestDescriptor {
	...
	public ClassBasedTestDescriptor(UniqueId uniqueId, Class<?> testClass, ConfigurationParameters configurationParameters) {
